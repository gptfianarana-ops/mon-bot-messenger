...
// ============================================================
// AFFICHER PROFIL & DÉFI QUOTIDIEN
// ============================================================
...
// ============================================================
// ROUTES ADMIN : CRÉDITS, BACC, DISPONIBILITÉ, RÉFÉRENCES
// ============================================================
...
// ============================================================
// ROUTEUR PRINCIPAL (handleEvent) - AVEC TOUS LES CAS
// ============================================================
const userModes = {};
...
async function handleEvent(senderId, texteOuPayload, estUnBouton) {
  ...
  switch (etat.mode) {
    // ============================================================
    // CAS EXISTANTS (vous les avez déjà dans votre fichier, je ne les recopie pas en détail ici)
    // Ils doivent être présents : resultats_menu, choix_province_bacc, resultats_bacc,
    // admin_identifiant, admin_motdepasse, admin_menu, admin_code_credits,
    // admin_confirmation_alerte, admin_code_perso,
    // simulation_bac_serie, simulation_bac_notes,
    // creation_cv, creation_cv_genre, creation_cv_loisirs_photo,
    // attente_code, humain, resultats, correction, traduction,
    // correction_exercices, exercices, defi_quotidien,
    // hianatra_menu, hianatra_session
    // ============================================================
...
// ============================================================
// FONCTIONS CV, SIMULATEUR BAC, MÉTHODOLOGIE, ETC.
// ============================================================
// --- SIMULATEUR BAC ---
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const ajusterPoliceZoneCible = (texte, largeur, hauteurCible, tailleDefaut, tailleMin, tailleMax) => {
        let taille = tailleDefaut;
        doc.fontSize(taille);
        let hauteur = doc.heightOfString(texte, { width: largeur,
